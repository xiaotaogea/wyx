...
public class UserPointController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType = "query", name = "type", value = "1是获取记录，2是消费记录 默认1", required = true, dataType = "int")
    })
    public PageInfo<UserPoint> getList(int uid, Integer currPage, Integer type) {
        ...
        pointList = userPointService.queryPointList(uid, fen);
